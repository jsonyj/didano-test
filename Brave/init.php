...
define('APP_RESOURCE_URL', 'http://test.xiaonuo.cn/res/');
// define('APP_RESOURCE_URL', 'http://test-image-didanuo.oss-cn-shanghai.aliyuncs.com/');
define('APP_WEICHAT_URL', 'http://test.xiaonuo.cn/wx/');
define('APP_SERVICE_URL', 'http://test.xiaonuo.cn/service/');
define('APP_API_URL', 'http://test.xiaonuo.cn/api/');
 ...
 * 微信相关配置
 */
define('WX_APP_URL', 'http://test.xiaonuo.cn/wx/');
...
* @desc App Config
*/
include_once(APP_CONFIG . 'App.inc.default.php');
...
// 定义OSS
define('ACCESSKEYID','LTAIAOgUvQP8QMI6');
define('ACCESSKEYSECRET', 'LaxZLDxFU1U78rB5rv3lXv5ReGD1Wy');
define('ENDPOINT', 'http://oss-cn-shenzhen.aliyuncs.com');
define('APP_OSS_URL', 'http://image-didanuo.oss-cn-shenzhen.aliyuncs.com/');
